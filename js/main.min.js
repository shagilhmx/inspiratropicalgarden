  ...
  let em = document.querySelector(
    `#${
      document.querySelector(
        check ? "#locationButton" : "#FooterForm #location",
      ).children[1].id
    }`,
  );
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        axios
          ...
          .then((res) => {
            document.querySelector(
              check ? "#detectText" : "#FooterForm #detectText",
            ).innerText = "Location Detected";
            document.querySelector(
              check ? "#loading" : "#FooterForm #loading",
            ).style.display = "none";
            document.querySelector(
              check ? "#locationButton" : "#FooterForm #locationButton",
...
function verfiyOtp(e, check) {
  ...
  axios
    ...
    .then((res) => {
      ...
      document.querySelector(
        check ? "#location" : "#FooterForm #location",
      ).style.display = "block";
      $(check ? "#DownloadFormModalTitle" : "#FooterForm #numberText").html("");
    })
    .catch((err) => {});
}
