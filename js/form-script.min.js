...
jQuery(
  (function ($) {
    "use strict";
    $(
      ".bookSiteVisitForm:not(#FooterForm #otpVerification):not(#FooterForm #location)",
    ).on("submit", function () {
      $(".bookingStatus").html(
      ...
      function fail_func01(data) {
        setTimeout(function () {
          $("#bookSiteVisitForm").css("display", "none"),
            $("#FooterForm #otpVerification").css("display", "block"),
            $("#FooterForm #bookSiteVisitFormTitle").html("Verification Code"),
            $("#FooterForm #numberText").html(
              $("#FooterForm #numberText").text() +
      ...
      $(".downloadBFPForm:not(#otpVerification):not(#location)").on(
        "submit",
        function () {
